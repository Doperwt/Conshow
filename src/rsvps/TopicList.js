...
const topics = [ { topic: 'Software Development', count: 95 },
  { topic: 'New Technology', count: 61 },
  { topic: 'Web Development', count: 48 },
  { topic: 'Computer programming', count: 43 },
  { topic: 'Open Source', count: 42 },
  { topic: 'Web Technology', count: 31 },
  { topic: 'Web Design', count: 26 },
  { topic: 'Technology Startups', count: 23 },
  { topic: 'Entrepreneurship', count: 21 },
  { topic: 'Knowledge Sharing', count: 19 } ]
